...
$mysqli = new mysqli('localhost','root' ,'', 'cr11_valentina_panetta_travelmatic');
...
<div class="col-lg-6 col-md-6 col-sm-12 pt-5">
    <form action="actions/create_event.php" method="POST">
        <div class="form-group">
            ...
            <input type="text" name="conc_name" class="form-control" id="name" aria-describedby="nameHelp" placeholder="Enter name">
            <small id="nameHelp" class="form-text text-muted">Input the name of the event</small>
        </div>
        <div class="form-group">
            <label for="venue">Venue</label>
            <input type="text" name="venue" class="form-control" id="venue" aria-describedby="nameHelp" placeholder="Enter name">
        ...
        <div class="form-group">
            ...
            <input type="text" name="conc_date" class="form-control" id="date" aria-describedby="dateHelp" placeholder="Enter date">
            <small id="dateHelp" class="form-text text-muted">Input the date of the event like so (YYYY-MM-DD)</small>
        </div>
        <div class="form-group">
            <label for="time">Event Time</label>
            <input type="text" name="conc_time" class="form-control" id="time" aria-describedby="timeHelp" placeholder="Enter time">
            <small id="timeHelp" class="form-text text-muted">Input the time of the event like so (HH:MM:SS)</small>
        </div>
        <div class="form-group">
            <label for="price">Event Price</label>
            <input type="text" name="conc_price" class="form-control" id="price" aria-describedby="nameHelp" placeholder="Enter price">
            <small id="nameHelp" class="form-text text-muted">Input the ticket amount in Euro</small>
        </div>
        <div class="form-group">
            <label for="website">Website</label>
            <input type="text" name="conc_web" class="form-control" id="website" aria-describedby="websiteHelp" placeholder="Enter the website link">
